...
class PriorityQueue(object):
    ...
    def enqueue(self, item, priority):
        ...
        heap_item = (priority, item)
        self.heap.insert(heap_item)
    ...
    def front(self):
        ...
        if self.size() == 0:
            return None
        priority, item = self.heap.get_min()
        return item
    ...
    def dequeue(self):
        ...
        priority, item = self.heap.delete_min()
        return item
    ...
    def push_pop(self, item, priority):
        ...
        heap_item = (priority, item)
        priority, item = self.heap.replace_min(heap_item)
        return item
